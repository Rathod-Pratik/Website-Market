...
const Footer  = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <a className="text-teal-600 items-center flex text-[20px]" href="/">
            ...
            <h2 className='text-primary'>Website-Market</h2>
          </a>
    </div>

    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
     Thanks for coming to purchase any code of Project
    </p>
